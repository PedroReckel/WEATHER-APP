...
import propTypes from 'prop-types'; // Definindo o tipo de props que eu vou receber no componente.
    ...
    return (
        ...
        <div className="bg-white p-6 mt-10 rounded-lg shadow-md min-w-[220px]">
            ...
            <div className="flex justify-center flex-col items-center">
                <img src={current.condition.icon} alt="Ícone de previsão do tempo" />
